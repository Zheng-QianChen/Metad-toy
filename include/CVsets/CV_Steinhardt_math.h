...
__device__ __forceinline__ void compute_qlm_forward_L3(
    ...
    // q,3,0
    d_stein_qlm_cut[0] += d_stein_Ylm_cut[0];
    d_stein_qlm_cut[1] += d_stein_Ylm_cut[1];
    // q,3,1
    d_stein_qlm_cut[2] += d_stein_Ylm_cut[2];
    d_stein_qlm_cut[3] += d_stein_Ylm_cut[3];
    // q,3,2
    d_stein_qlm_cut[4] += d_stein_Ylm_cut[4];
    d_stein_qlm_cut[5] += d_stein_Ylm_cut[5];
    // q,3,3
    d_stein_qlm_cut[6] += d_stein_Ylm_cut[6];
    d_stein_qlm_cut[7] += d_stein_Ylm_cut[7];
...
__device__ __forceinline__ void compute_qlm_forward_L4(
    ...
    d_stein_qlm_cut[7] += d_stein_Ylm_cut[7];
    // q,4,4
    d_stein_qlm_cut[8] += d_stein_Ylm_cut[8];
    d_stein_qlm_cut[9] += d_stein_Ylm_cut[9];
}
...
__device__ __forceinline__ void compute_qlm_forward_L6(
    ...
    d_stein_qlm_cut[9] += d_stein_Ylm_cut[9];
    // q,6,5
    d_stein_qlm_cut[10] += d_stein_Ylm_cut[10];
    d_stein_qlm_cut[11] += d_stein_Ylm_cut[11];
    // q,6,6
    d_stein_qlm_cut[12] += d_stein_Ylm_cut[12];
