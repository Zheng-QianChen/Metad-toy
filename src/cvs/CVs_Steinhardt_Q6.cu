...
__global__ void dcv_steinhardt_param_calc_kernel_q6(
    ...
    // for (int c_atom=0; c_atom<group_count; c_atom++){
        ...
        for(int neigh_atom=0; neigh_atom<neigh_num; neigh_atom++){
            ...
            // d Y,6,4 dx
            // d_dYlm_dr[c_atom*3*2+0]+= (tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 8] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 8]) ;
            // d_dYlm_dr[c_atom*3*2+1]+= (tdx_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 9] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 9]) ;
            // d Y,6,4 dy
            // d_dYlm_dr[c_atom*3*2+2]+= (tdy_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 8] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 8]) ;
            // d_dYlm_dr[c_atom*3*2+3]+= (tdy_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 9] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 9]) ;
            // d Y,6,4 dz
            // d_dYlm_dr[c_atom*3*2+4]+= (tdz_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 8] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 8]) ;
            // d_dYlm_dr[c_atom*3*2+5]+= (tdz_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 9] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 9]) ;
            // d Y,6,-4 dx
            // d_dYlm_dr[c_atom*3*2+0]+= (tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 8] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 8]) ;
            // d_dYlm_dr[c_atom*3*2+1]+= -(tdx_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 9] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 9]) ;
            // d Y,6,-4 dy
            ...
            d_dYlm_dr[c_atom*3*2+0]+= 2*(tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 8] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 8]) ;
            d_dYlm_dr[c_atom*3*2+1]+= 0 ;
            // d Y,6,4 dx + d Y,6,-4 dy
            d_dYlm_dr[c_atom*3*2+2]+= 2*(tdy_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 8] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 8]) ;
            d_dYlm_dr[c_atom*3*2+3]+= 0 ;
            // d Y,6,4 dx + d Y,6,-4 dz
            d_dYlm_dr[c_atom*3*2+4]+= 2*(tdz_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 8] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 8]) ;
            d_dYlm_dr[c_atom*3*2+5]+= 0 ;
            ...
            // d Y,6,5 dx
            // d_dYlm_dr[c_atom*3*2+0]+= (tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 10] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 10]) ;
            // d_dYlm_dr[c_atom*3*2+1]+= (tdx_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 11] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 11]) ;
            // d Y,6,5 dy
            // d_dYlm_dr[c_atom*3*2+2]+= (tdy_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 10] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 10]) ;
            // d_dYlm_dr[c_atom*3*2+3]+= (tdy_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 11] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 11]) ;
            // d Y,6,5 dz
            // d_dYlm_dr[c_atom*3*2+4]+= (tdz_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 10] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 10]) ;
            // d_dYlm_dr[c_atom*3*2+5]+= (tdz_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 11] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 11]) ;
            // d Y,6,-5 dx
            // d_dYlm_dr[c_atom*3*2+0]+= -(tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 10] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 10]) ;
            // d_dYlm_dr[c_atom*3*2+1]+= (tdx_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 11] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 11]) ;
            // d Y,6,-5 dy
            ...
            d_dYlm_dr[c_atom*3*2+0]+= 0 ;
            d_dYlm_dr[c_atom*3*2+1]+= 2*(tdx_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 11] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 11]) ;
            // d Y,6,5 dx + d Y,6,-5 dy
            d_dYlm_dr[c_atom*3*2+2]+= 0 ;
            d_dYlm_dr[c_atom*3*2+3]+= 2*(tdy_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 11] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 11]) ;
            // d Y,6,5 dx + d Y,6,-5 dz
            d_dYlm_dr[c_atom*3*2+4]+= 0 ;
            d_dYlm_dr[c_atom*3*2+5]+= 2*(tdz_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 11] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 11]) ;
            ...
            // d Y,6,6 dx
            // d_dYlm_dr[c_atom*3*2+0]+= (tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 12] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 12]) ;
            // d_dYlm_dr[c_atom*3*2+1]+= (tdx_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 13] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 13]) ;
            // d Y,6,6 dy
            // d_dYlm_dr[c_atom*3*2+2]+= (tdy_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 12] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 12]) ;
            // d_dYlm_dr[c_atom*3*2+3]+= (tdy_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 13] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 13]) ;
            // d Y,6,6 dz
            // d_dYlm_dr[c_atom*3*2+4]+= (tdz_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 12] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 12]) ;
            // d_dYlm_dr[c_atom*3*2+5]+= (tdz_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 13] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 13]) ;
            // d Y,6,-6 dx
            // d_dYlm_dr[c_atom*3*2+0]+= (tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 12] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 12]) ;
            // d_dYlm_dr[c_atom*3*2+1]+= -(tdx_i)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 13] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 13]) ;
            // d Y,6,-6 dy
            ...
            d_dYlm_dr[c_atom*3*2+0]+= 2*(tdx_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 12] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 12]) ;
            d_dYlm_dr[c_atom*3*2+1]+= 0 ;
            // d Y,6,6 dx + d Y,6,-6 dy
            d_dYlm_dr[c_atom*3*2+2]+= 2*(tdy_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 12] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 12]) ;
            d_dYlm_dr[c_atom*3*2+3]+= 0 ;
            // d Y,6,6 dx + d Y,6,-6 dz
            d_dYlm_dr[c_atom*3*2+4]+= 2*(tdz_r)*(catom_q4_timesN*2*d_stein_qlm[stein_qlm_base_id + 12] + neigh_q6_timesN*2*d_stein_qlm[stein_qlm_neigh_id + 12]) ;
            d_dYlm_dr[c_atom*3*2+5]+= 0 ;
        }
        for (int i=0;i<3;i++){
